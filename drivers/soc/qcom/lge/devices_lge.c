...
#if defined(CONFIG_MACH_SDM450_CV7AS) || defined(CONFIG_MACH_SDM450_PD_OPEN_COM)
char *lge_rev_str[] = {"rev_0", "rev_01", "rev_a",
	"rev_a_1", "rev_b", "rev_c", "rev_d","rev_10",
	"rev_11", "reserved"};
#elif defined(CONFIG_MACH_SDM450_MH4X)
char *lge_rev_str[] = {"rev_0", "rev_02", "rev_a", "rev_a_1", "rev_b", "rev_b_1", "rev_b_2", "rev_c",
        "rev_10", "rev_11", "rev_12", "rev_13", "reserved"};
#elif defined(CONFIG_MACH_MSM8917_MH5LM) || defined(CONFIG_MACH_MSM8917_MH5LM_NONAB)
char *lge_rev_str[] = {"rev_0", "rev_a", "rev_b", "rev_c", "rev_d", "rev_e",
	"rev_f", "rev_g", "rev_h", "rev_10", "rev_11", "reserved"};
#elif defined(CONFIG_MACH_SDM450_MH3J)
char *lge_rev_str[] = {"rev_0", "rev_01", "rev_02", "rev_a", "rev_a_1",
	"rev_b", "rev_b_1", "rev_b_2", "rev_c",
...
static lge_laf_mode_t lge_laf_mid = LGE_LAF_MODE_NORMAL;
...
lge_laf_mode_t lge_get_laf_mid(void)
{
	return lge_laf_mid;
}
#endif
...
#ifdef CONFIG_INPUT_FINGERPRINT
...
#endif // CONFIG_INPUT_FINGERPRINT
...
int __init lge_sku_carrier_init(char *s)
{
	if (!strcmp(s, "LAO"))
		...
		lge_sku_carrier = CAN;
	else if (!strcmp(s, "MPCS71"))
		lge_sku_carrier = MPCS71;
	else if (!strcmp(s, "SPR"))
		lge_sku_carrier = SPR;
	else if (!strcmp(s, "GLOBAL"))
		lge_sku_carrier = GLOBAL;
	else if (!strcmp(s, "KR_ALL"))
		lge_sku_carrier = KR_ALL;
	else
...
int __init lge_ntcode_op_init(char *s)
{
	...
	else if (!strcmp(s, "CHARTER"))
		lge_ntcode_op = OP_CHARTER_US;
	else if (!strcmp(s, "VISIBLE"))
		lge_ntcode_op = OP_VISIBLE;
	else if (!strcmp(s, "DISH"))
		lge_ntcode_op = OP_DISH;
	else
