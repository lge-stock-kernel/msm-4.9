...
#define GESTURE_ON_CTRL                 (0x60)
#define SWIPE_DIST_THRESHOLD_CTRL       (0x61)
#define SWIPE_RATIO_THRESHOLD_CTRL      (0x62)
#define SWIPE_TIME_MIN_H_CTRL           (0x63)
#define SWIPE_TIME_MIN_L_CTRL           (0x64)
#define SWIPE_TIME_MAX_H_CTRL           (0x65)
#define SWIPE_TIME_MAX_L_CTRL           (0x66)
#define SWIPE_WRONG_DIRECTION_THD_H_CTRL        (0x67)
//#define SWIPE_WRONG_DIRECTION_THD_L_CTRL        (0x68)

#define SWIPE_ACTIVE_AREA_X1_H_CTRL     (0x68)
#define SWIPE_ACTIVE_AREA_X1_L_CTRL     (0x69)
#define SWIPE_ACTIVE_AREA_Y1_H_CTRL     (0x6A)
#define SWIPE_ACTIVE_AREA_Y1_L_CTRL     (0x6B)
#define SWIPE_ACTIVE_AREA_X2_H_CTRL     (0x6C)
#define SWIPE_ACTIVE_AREA_X2_L_CTRL     (0x6D)
#define SWIPE_ACTIVE_AREA_Y2_H_CTRL     (0x6E)
#define SWIPE_ACTIVE_AREA_Y2_L_CTRL     (0x6F)

#define SWIPE_START_AREA_X1_H_CTRL              (0x70)
#define SWIPE_START_AREA_X1_L_CTRL              (0x71)
#define SWIPE_START_AREA_Y1_H_CTRL              (0x72)
#define SWIPE_START_AREA_Y1_L_CTRL              (0x73)
#define SWIPE_START_AREA_X2_H_CTRL              (0x74)
#define SWIPE_START_AREA_X2_L_CTRL              (0x75)
#define SWIPE_START_AREA_Y2_H_CTRL              (0x76)
#define SWIPE_START_AREA_Y2_L_CTRL              (0x77)
#define SWIPE_INIT_RATIO_CHK_DIST_CTRL  	(0x78)
#define SWIPE_INIT_RATIO_THD_CTRL               (0x79)
...
enum {
	BOE_INCELL_FT8006P = 1,
	CPT_INCELL_FT8006P = 2,
};
