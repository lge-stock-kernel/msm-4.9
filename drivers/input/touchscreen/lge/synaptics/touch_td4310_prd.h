...
#define SET_LIMIT(COND, A, B, C) ((COND <= TOUCH_MINIOS_AAT) ? A : ((COND == TOUCH_MINIOS_MFTS_FOLDER) ? A##B : A##C))
...
enum mfts_flat_spec {
	RAW_DATA_MAX_MFTS_FLAT       = 3200,
	RAW_DATA_MIN_MFTS_FLAT       = 1000,
	RAW_DATA_MARGIN_MFTS_FLAT    = 0,
	P2P_NOISE_MAX_MFTS_FLAT      = 50,
	P2P_NOISE_MIN_MFTS_FLAT      = 0,

	NOISE_TEST_FRM_MFTS_FLAT     = 50,
	E2E_SHORT_MAX_MFTS_FLAT      = 90,
	E2E_SHORT_MIN_MFTS_FLAT      = 0,
	ELECTRODE_OPEN_MAX_MFTS_FLAT = 500,
	ELECTRODE_OPEN_MIN_MFTS_FLAT = 30,

	LPWG_RAW_DATA_MAX_MFTS_FLAT  = 3100,
	LPWG_RAW_DATA_MIN_MFTS_FLAT  = 900,
