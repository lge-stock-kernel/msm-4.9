...
int anx7625_smallpd_mdss_dsi_panel_power_on(struct mdss_panel_data *pdata)
{
	int ret = 0;
	...
	ret = gpio_direction_output(GPIO_LCD_3V3_BUCK, 1);//gpio 50 --> 3.3 buck
	if(ret)
...
int anx7625_smallpd_mdss_dsi_panel_power_off(struct mdss_panel_data *pdata)
{
	int ret = 0;
	struct mdss_dsi_ctrl_pdata *ctrl_pdata = NULL;
...
void anx7625_smallpd_panel_enter_deep_sleep(void)
{
...
void anx7625_smallpd_panel_exit_deep_sleep(void)
{
	struct mdss_dsi_ctrl_pdata *pdata = NULL;
...
void anx7625_smallpd_mdss_dsi_ctrl_shutdown(struct platform_device *pdev)
{
...
int anx7625_smallpd_mdss_dsi_panel_reset(struct mdss_panel_data *pdata, int enable)
{
	struct mdss_dsi_ctrl_pdata *ctrl_pdata = NULL;
