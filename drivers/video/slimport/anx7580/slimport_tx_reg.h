...
#define SP_COMMON_INT2_MIPI_LPCD_DET		0x80//bit position
#define SP_COMMON_INT2_MIPI_HTOTAL_CHG		0x10//bit position
...
#define SP_COMMON_INT3_MIPI_PACKET_LEN_CHG		0x10//bit position
#define SP_COMMON_INT3_MIPI_LANE_CLK_CHG		0x08//bit position
