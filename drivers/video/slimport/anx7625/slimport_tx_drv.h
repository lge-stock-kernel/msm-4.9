...
#define sp_write_reg_anx7625_mask(address, offset, mask, reg_value) \
	do { \
		unsigned char temp_value; \
		sp_read_reg_anx7625(address, offset, &temp_value); \
		sp_write_reg_anx7625(address, offset, (temp_value&mask)|reg_value); \
		}while(0);
...
//void SP_TX_Wait_AUX_Finished3(void);
...
void SP_TX_Embedded_Sync3(struct VideoFormat* pInputFormat, unsigned int sp_tx_bist_select_number);
void SP_TX_DE_reGenerate3 (unsigned int sp_tx_bist_select_number);
...
void SP_TX_LVTTL_Bit_Mapping3(struct VideoFormat* pInputFormat);
...
void SP_TX_Config_MIPI_Video_Format3(void);
...
_SP_TX_DRV_EX_C_ BYTE ByteBuf3[MAX_BUF_CNT];

_SP_TX_DRV_EX_C_ SP_TX_System_State sp_tx_system_state3;
//for EDID
_SP_TX_DRV_EX_C_ BYTE edid_pclk3_out_of_range3;//the flag when clock out of 256Mhz
_SP_TX_DRV_EX_C_ BYTE sp_tx_edid_err_code3;//EDID read  error type flag
_SP_TX_DRV_EX_C_ BYTE bEDIDBreak3; //EDID access break


//for HDCP

_SP_TX_DRV_EX_C_ BYTE sp_tx_pd_mode3; //ANX7625 power state flag
//for bist video index
_SP_TX_DRV_EX_C_ unsigned int bBIST_FORMAT_INDEX3;
_SP_TX_DRV_EX_C_ BYTE bBIST_FORMAT_INDEX3_backup;
_SP_TX_DRV_EX_C_ BYTE Force_Video_Resolution3;
//external interrupt flag
_SP_TX_DRV_EX_C_ BYTE ext_int_index3;

_SP_TX_DRV_EX_C_ struct VideoFormat SP_TX_Video_Input3;
_SP_TX_DRV_EX_C_ struct AudioFormat SP_TX_Audio_Input3;
...
_SP_TX_DRV_EX_C_ enum RX_CBL_TYPE sp_tx_rx_type3;

_SP_TX_DRV_EX_C_ BYTE CEC_abort_message_received3;
_SP_TX_DRV_EX_C_ BYTE CEC_get_physical_adress_message_received3;
_SP_TX_DRV_EX_C_ BYTE  CEC_logic_addr3;
_SP_TX_DRV_EX_C_ int      CEC_loop_number3;
_SP_TX_DRV_EX_C_ BYTE CEC_resent_flag3;



_SP_TX_DRV_EX_C_ SP_TX_Link_Training_State sp_tx_link_training_state3;
_SP_TX_DRV_EX_C_ HDCP_Process_State hdcp_process_state3;

//for EDID
_SP_TX_DRV_EX_C_ BYTE checksum3;
_SP_TX_DRV_EX_C_ BYTE SP_TX_EDID_PREFERRED3[18];//edid DTD array
_SP_TX_DRV_EX_C_ BYTE sp_tx_ds_edid_hdmi3; //Downstream is HDMI flag
_SP_TX_DRV_EX_C_ BYTE sp_tx_ds_edid_3d_present3;//downstream monitor support 3D
_SP_TX_DRV_EX_C_ BYTE DTDbeginAddr3;
_SP_TX_DRV_EX_C_ BYTE EDID_Print_Enable3;
_SP_TX_DRV_EX_C_ BYTE EDIDExtBlock3[128];

_SP_TX_DRV_EX_C_ unsigned long pclk3; //input video pixel clock
_SP_TX_DRV_EX_C_ long int M_val3,N_val3;
_SP_TX_DRV_EX_C_ SP_LINK_BW sp_tx_bw3;  //linktraining banwidth
_SP_TX_DRV_EX_C_ BYTE sp_tx_lane_count3; //link training lane count
#if(AUTO_TEST_CTS)
_SP_TX_DRV_EX_C_ BYTE sp_tx_test_lt3;
_SP_TX_DRV_EX_C_ BYTE sp_tx_test_bw3;
_SP_TX_DRV_EX_C_ BYTE sp_tx_test_edid3;
#endif
_SP_TX_DRV_EX_C_ unchar sp_rx_bw3;  //sink banwidth

_SP_TX_DRV_EX_C_ struct AudiInfoframe SP_TX_AudioInfoFrmae3;
_SP_TX_DRV_EX_C_ struct Packet_AVI SP_TX_Packet_AVI3;
_SP_TX_DRV_EX_C_ struct Packet_MPEG SP_TX_Packet_MPEG3;
_SP_TX_DRV_EX_C_ struct Packet_SPD SP_TX_Packet_SPD3;


_SP_TX_DRV_EX_C_ BYTE bMIPI_Configured3;
_SP_TX_DRV_EX_C_ BYTE bMIPIFormatIndex3;
_SP_TX_DRV_EX_C_ struct MIPI_Video_Format mipi_video_timing_table3[];
_SP_TX_DRV_EX_C_ unsigned int mipi_lane_count3;
//for MIPI Video format config

_SP_TX_DRV_EX_C_ BYTE bEDID_extblock3[128];
_SP_TX_DRV_EX_C_ BYTE bEDID_firstblock3[128];
_SP_TX_DRV_EX_C_ BYTE bEDID_fourblock3[256];

_SP_TX_DRV_EX_C_ bool audio_format_change3;
_SP_TX_DRV_EX_C_ bool video_format_change3;
_SP_TX_DRV_EX_C_ bool hdcp_enable3;
