...
include $(DLKM_DIR)/AndroidKernelModule.mk
###########################################################
ifeq ($(LGE_HAL_AUDIO_HIFI_SOUND),true)
include $(CLEAR_VARS)
...
###########################################################
ifeq ($(LGE_HAL_AUDIO_LGE_ESS_DIGITAL_FILTER),true)
include $(CLEAR_VARS)
...
###########################################################
ifeq ($(LGE_HAL_AUDIO_TI_SPK_AMP),true)
include $(CLEAR_VARS)
LOCAL_MODULE              := $(AUDIO_CHIPSET)_tas2560_calib.ko
LOCAL_MODULE_KBUILD_NAME  := tas2560_calib_dlkm.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/AndroidKernelModule.mk
include $(CLEAR_VARS)
LOCAL_MODULE              := $(AUDIO_CHIPSET)_tas2560_regmap.ko
LOCAL_MODULE_KBUILD_NAME  := tas2560_regmap_dlkm.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/AndroidKernelModule.mk
include $(CLEAR_VARS)
LOCAL_MODULE              := $(AUDIO_CHIPSET)_tas2560_core.ko
LOCAL_MODULE_KBUILD_NAME  := tas2560_core_dlkm.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/AndroidKernelModule.mk
include $(CLEAR_VARS)
LOCAL_MODULE              := $(AUDIO_CHIPSET)_tas2560_codec.ko
LOCAL_MODULE_KBUILD_NAME  := tas2560_codec_dlkm.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/AndroidKernelModule.mk
include $(CLEAR_VARS)
LOCAL_MODULE              := $(AUDIO_CHIPSET)_tas2560_misc.ko
LOCAL_MODULE_KBUILD_NAME  := tas2560_misc_dlkm.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/AndroidKernelModule.mk
