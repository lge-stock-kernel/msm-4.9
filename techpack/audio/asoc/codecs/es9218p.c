...
static u8  normal_harmonic_comp_left[4] = {0x00, 0x00, 0xd0, 0xf7};
static u8  normal_harmonic_comp_right[4] = {0xc0, 0xff, 0xa0, 0xfb};
static u8  advance_harmonic_comp_left[4] = {0x30, 0x02, 0x30, 0x00};
static u8  advance_harmonic_comp_right[4] = {0x00, 0x02, 0x20, 0x00};
static u8  aux_harmonic_comp_left[4] = {0x40, 0x01, 0x80, 0xfd};
static u8  aux_harmonic_comp_right[4] = {0x40, 0x01, 0x20, 0xfe};
#else
static u8  normal_harmonic_comp_left[4] = {0x0a, 0x00, 0x1e, 0xfb};
static u8  normal_harmonic_comp_right[4] = {0x0a, 0x00, 0x1e, 0xfb};
        ...
        struct snd_ctl_elem_value *ucontrol)
{
    ...
    if ((value != 0) && (g_headset_type != value)) {
