...
static int __init tas2560_i2c_init(void)
{
	int ret = 0;
	ret = i2c_add_driver(&tas2560_i2c_driver);
	return ret;
}

module_init(tas2560_i2c_init);

static void __exit tas2560_i2c_exit(void)
{
	i2c_del_driver(&tas2560_i2c_driver);
}

module_exit(tas2560_i2c_exit);
