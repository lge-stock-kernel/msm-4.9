...
EXPORT_SYMBOL(tas2560_set_SampleRate);
...
EXPORT_SYMBOL(tas2560_set_bit_rate);
...
EXPORT_SYMBOL(tas2560_get_bit_rate);
...
EXPORT_SYMBOL(tas2560_get_volume);
...
EXPORT_SYMBOL(tas2560_set_volume);
...
EXPORT_SYMBOL(tas2560_parse_dt);
...
EXPORT_SYMBOL(tas2560_LoadConfig);
