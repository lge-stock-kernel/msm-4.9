...
/*
 * Below five GPIOs are example  for AP to control the Slimport chip ANX7580. 
...
#define debug_printf(fmt, arg...) pr_err(fmt,##arg)
#define debug_puts(fmt) pr_err(fmt)
...
#elif defined CONFIG_SLIMPORT_ANX7580
#define LOG_TAG "[anx7580]"
#else
...
#if defined (CONFIG_SLIMPORT_ANX7808)  || defined (CONFIG_SLIMPORT_ANX7580)
bool slimport_is_connected3(void);
#else
static inline bool slimport_is_connected3(void)
{
	return false;
}
#endif
